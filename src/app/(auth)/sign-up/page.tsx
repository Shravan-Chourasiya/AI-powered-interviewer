            ...
            <div className="w-full max-w-md space-y-6 sm:space-y-8 p-6 sm:p-8 rounded-2xl shadow-2xl border border-slate-200 dark:border-gray-800 backdrop-blur-sm relative overflow-hidden bg-white dark:bg-gray-900">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 sm:space-y-6">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-slate-700 dark:text-gray-300 text-sm sm:text-base">Username</FormLabel>
                                    <FormControl>
                                        <Input 
                                            type="text" 
                                    ...
                                    <p className={`text-xs sm:text-sm ${userMsg === "Username Is Available" ? "text-green-400" : "text-red-400"}`}>{userMsg}</p>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-slate-700 dark:text-gray-300 text-sm sm:text-base">Email</FormLabel>
                                    <FormControl>
                                        <Input 
                                            className="bg-white dark:bg-gray-800/50 border-slate-300 dark:border-gray-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-100 dark:focus:ring-purple-400/20 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-gray-400 transition-all duration-200 shadow-sm h-12 text-base"
                                            placeholder="Email ..." 
                ...
                <div className="text-center pt-4 sm:pt-6 border-t border-slate-200 dark:border-gray-800">
                    <p className="text-sm text-slate-600 dark:text-gray-400">
                        ...
                        <Link href="/sign-in" className="font-medium transition-colors duration-200 hover:underline text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 touch-manipulation">
                            Sign In
                        </Link>
                    </p>
                </div>
