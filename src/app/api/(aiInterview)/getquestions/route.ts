...
export async function POST(req: Request) {
    ...
    const getQuestionsPrompt: string = `You are an expert technical interviewer hiring a ${fieldname} ${experience}. Generate questions for a ${position} role at ${company}.
