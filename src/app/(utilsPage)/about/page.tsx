    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        ...
        <div className="grid grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-lg order-1 lg:order-2">
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center">
                ...
                <div className="text-muted-foreground text-sm">Interviews Conducted</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-muted-foreground text-sm">Job Categories</div>
              </div>
              <div className="text-center">
        ...
        {/* Features Section */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-foreground text-center mb-12">Why Choose SyntheView?</h2>
          <div className="grid grid-cols-4 gap-8">
            <div className="bg-card border border-border rounded-xl p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">Advanced AI technology provides realistic interview scenarios and personalized feedback.</p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Targeted Practice</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">Practice for specific roles and industries with customized question sets.</p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Expert Insights</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">Get feedback based on industry best practices and hiring manager expectations.</p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">Your practice sessions are private and secure. We never share your data.</p>
            </div>
          </div>
        </div>
        ...
        {/* Team Section */}
        <div className="text-center">
          <h2 className="text-3xl font-bold text-foreground mb-6">Built by Interview Experts</h2>
