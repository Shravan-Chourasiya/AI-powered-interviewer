  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        ...
        {/* Features Section */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-slate-800 dark:text-white text-center mb-12">Why Choose SyntheView?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              <div className="p-3 rounded-lg bg-gradient-to-r from-purple-500 to-teal-500 w-fit mb-4">
                <Zap className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3">AI-Powered</h3>
              <p className="text-slate-600 dark:text-gray-300 text-sm">Advanced AI technology provides realistic interview scenarios and personalized feedback.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3">Targeted Practice</h3>
              <p className="text-slate-600 dark:text-gray-300 text-sm">Practice for specific roles and industries with customized question sets.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3">Expert Insights</h3>
              <p className="text-slate-600 dark:text-gray-300 text-sm">Get feedback based on industry best practices and hiring manager expectations.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-3">Privacy First</h3>
              <p className="text-slate-600 dark:text-gray-300 text-sm">Your practice sessions are private and secure. We never share your data.</p>
            </div>
          </div>
        </div>
        ...
        {/* Team Section */}
        <div className="text-center">
          <h2 className="text-3xl font-bold text-slate-800 dark:text-white mb-6">Built by Interview Experts</h2>
          <p className="text-slate-600 dark:text-gray-300 text-lg max-w-3xl mx-auto mb-8">
