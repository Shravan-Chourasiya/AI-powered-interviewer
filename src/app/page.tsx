...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center min-h-screen px-4 sm:px-6 py-20">
        {/* Hero Section */}
        <div className="text-center flex flex-col justify-center items-center max-w-6xl mx-auto space-y-8">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-teal-400 bg-clip-text text-transparent leading-tight">
            Ace Your Next Interview
          </h1>
          
          <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-slate-700 dark:text-white font-semibold max-w-4xl">
            AI-Powered Mock Interviews That Feel Real
          </h2>
          
          <p className="text-lg sm:text-xl text-slate-600 dark:text-gray-300 max-w-3xl leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mt-12 mb-16">
          ...
          <Link href='/about'>
            <Button className="group px-10 py-5 bg-white dark:bg-slate-800/50 backdrop-blur-sm border-2 border-slate-200 dark:border-slate-600 hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-slate-700 text-slate-700 dark:text-gray-300 hover:text-purple-700 dark:hover:text-white rounded-2xl font-bold text-xl hover:scale-[1.05] transition-all duration-300 shadow-lg hover:shadow-xl min-w-64">
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 max-w-5xl mx-auto w-full">
          <div className="group text-center bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700/50 rounded-2xl p-6 hover:border-purple-400 hover:shadow-lg dark:hover:border-purple-400/50 hover:scale-[1.02] transition-all duration-300">
          ...
          <div className="group text-center bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700/50 rounded-2xl p-6 hover:border-emerald-400 hover:shadow-lg dark:hover:border-emerald-400/50 hover:scale-[1.02] transition-all duration-300">
            ...
            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-purple-400 to-teal-400 bg-clip-text text-transparent mb-2">50+</div>
            <div className="text-slate-600 dark:text-gray-400 font-medium group-hover:text-slate-800 dark:group-hover:text-gray-300 transition-colors text-sm sm:text-base">Job Categories</div>
          </div>
          <div className="group text-center bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700/50 rounded-2xl p-6 hover:border-amber-400 hover:shadow-lg dark:hover:border-amber-400/50 hover:scale-[1.02] transition-all duration-300">
            ...
            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-purple-400 to-teal-400 bg-clip-text text-transparent mb-2">24/7</div>
            <div className="text-slate-600 dark:text-gray-400 font-medium group-hover:text-slate-800 dark:group-hover:text-gray-300 transition-colors text-sm sm:text-base">Available</div>
          </div>
        </div>
      </div>
    </main>
